...
class TaxonomyServiceProvider extends ServiceProvider
{
    ...
    /**
     * Register the Taxonomy module service provider.
     *
    ...
    {
        App::register('App\Modules\Taxonomy\Providers\RouteServiceProvider');

        Lang::addNamespace('taxonomy', realpath(__DIR__ . '/../Resources/Lang'));
        View::addNamespace('taxonomy', realpath(__DIR__ . '/../Resources/Views'));
    }
