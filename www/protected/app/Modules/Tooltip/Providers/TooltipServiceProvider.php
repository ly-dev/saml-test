...
class TooltipServiceProvider extends ServiceProvider
{
    ...
    /**
     * Register the Tooltip module service provider.
     *
    ...
    {
        App::register('App\Modules\Tooltip\Providers\RouteServiceProvider');

        Lang::addNamespace('tooltip', realpath(__DIR__ . '/../Resources/Lang'));
        View::addNamespace('tooltip', realpath(__DIR__ . '/../Resources/Views'));
    }
